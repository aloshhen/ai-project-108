...
- React (для создания интерактивных компонентов и управления состоянием)
- Next.js (для SSR и оптимизации производительности)
- Tailwind CSS (для быстрой стилизации и адаптивного дизайна)
- Framer Motion (для анимаций и интерактивных элементов)
- Telegram Web App API (для интеграции с Telegram Mini App)
